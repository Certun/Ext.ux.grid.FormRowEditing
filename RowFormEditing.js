...
Ext.define('Ext.ux.grid.RowFormEditing', {
    ...
    /**
     * @cfg {Boolean} enableRemove
     * Set true to show a Remove button in the row editor to remove the record
     * Defaults to false.
     */
    enableRemove:false,
    ...
    initEditor: function() {
        ...
        return Ext.create('Ext.ux.grid.RowFormEditor', cfg);
    },
